...
// LockAllOpts Optional parameters for the method 'LockAll'
type LockAllOpts struct {
    Fields optional.String
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectId Id of project
 * @param optional nil or *LockAllOpts - Optional Parameters:
 * @param "Fields" (optional.String) -  Requested fields
@return string
*/
func (a *ProjectApiService) LockAll(ctx _context.Context, projectId string, localVarOptionals *LockAllOpts) (string, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/manifest/lock_all"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", projectId)), -1)
