 ...
 * @param "Sorts" (optional.String) -  Fields to sort by.
 * @param "Id" (optional.String) -  Match User Id.
 ...
 * @param "ContentMetadataId" (optional.String) -  Search for users who have access to this content_metadata item
 * @param "GroupId" (optional.String) -  Search for users who are direct members of this group
@return []User
*/
...
// SendUserCredentialsEmailPasswordResetOpts Optional parameters for the method 'SendUserCredentialsEmailPasswordReset'
type SendUserCredentialsEmailPasswordResetOpts struct {
    Fields optional.String
}

/*
SendUserCredentialsEmailPasswordReset Send Password Reset Token
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId Id of user
 * @param optional nil or *SendUserCredentialsEmailPasswordResetOpts - Optional Parameters:
 * @param "Fields" (optional.String) -  Requested fields.
@return CredentialsEmail
*/
func (a *UserApiService) SendUserCredentialsEmailPasswordReset(ctx _context.Context, userId int64, localVarOptionals *SendUserCredentialsEmailPasswordResetOpts) (CredentialsEmail, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/{user_id}/credentials_email/send_password_reset"
	localVarPath = strings.Replace(localVarPath, "{"+"user_id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", userId)), -1)
