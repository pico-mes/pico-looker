 ...
 * @param body Writable command parameters
@return Command
*/
func (a *CommandApiService) CreateCommand(ctx _context.Context, body Command) (Command, *_nethttp.Response, error) {
	var (
...
/*
DeleteCommand Delete a custom command
### Delete an existing custom command. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param commandId ID of a command
*/
func (a *CommandApiService) DeleteCommand(ctx _context.Context, commandId int64) (*_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/commands/{command_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"command_id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", commandId)), -1)
...
// GetAllCommandsOpts Optional parameters for the method 'GetAllCommands'
type GetAllCommandsOpts struct {
...
### Get All Commands. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetAllCommandsOpts - Optional Parameters:
 * @param "ContentId" (optional.String) -  Id of the associated content. This must be accompanied with content_type.
 * @param "ContentType" (optional.String) -  Type of the associated content. This must be accompanied with content_id.
 * @param "Limit" (optional.Int64) -  Number of results to return.
@return []Command
*/
func (a *CommandApiService) GetAllCommands(ctx _context.Context, localVarOptionals *GetAllCommandsOpts) ([]Command, *_nethttp.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.ContentId.IsSet() {
		localVarQueryParams.Add("content_id", parameterToString(localVarOptionals.ContentId.Value(), ""))
	}
...
/*
UpdateCommand Update a custom command
### Update an existing custom command. # Optional fields: [&#39;name&#39;, &#39;description&#39;] # 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param commandId ID of a command
 * @param body Re-writable command parameters
@return Command
*/
func (a *CommandApiService) UpdateCommand(ctx _context.Context, commandId int64, body UpdateCommand) (Command, *_nethttp.Response, error) {
	var (
