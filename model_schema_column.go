...
package looker
// SchemaColumn struct for SchemaColumn
type SchemaColumn struct {
	// Schema item name
	Name string `json:"name,omitempty"`
	// Full name of item
	SqlEscapedName string `json:"sql_escaped_name,omitempty"`
	// Name of schema
	SchemaName string `json:"schema_name,omitempty"`
	// SQL dialect data type
	DataTypeDatabase string `json:"data_type_database,omitempty"`
	// Data type
	DataType string `json:"data_type,omitempty"`
	// Looker data type
	DataTypeLooker string `json:"data_type_looker,omitempty"`
	// SQL data type
	Description string `json:"description,omitempty"`
	// Column data size
	ColumnSize int64 `json:"column_size,omitempty"`
